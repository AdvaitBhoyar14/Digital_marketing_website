...
<html lang="en" dir="ltr">
  ...
  <script>
    function formvalid() {
      ...
      if (vaildpass.length <= 3 || vaildpass.length >= 20) {
        document.getElementById("vaild-pass").innerHTML = "Minimum 3 characters";
        return false;
      } else {
    ...
    <div class="login-page">
        <div class="form">
            <form class="login-form" action="" method="post">
                ...
                <input type="text" required placeholder="Email ID" name="Username" id="user" autocomplete="off" />
